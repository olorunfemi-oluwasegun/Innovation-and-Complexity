  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredData = jsonData.filter(item => item.Year >= 2008 && item.Year <= 2019);
